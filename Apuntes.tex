...
\begin{definition}
	...
	\begin{enumerate}
		...
		\item $f(t, \varphi(t))$,  $\forall t \in I$.
	\end{enumerate}
...
\begin{theorem}[Construccion de solución $ \varepsilon $-aproximada.]
	Dada (*), con $ A $ abierto, $ f $ continua y acotada en $ A $ y sea $ \varepsilon>0, \varepsilon\in \mathbb{R} $. 
...
\begin{proof}
	...
	\[ \inf \{d_\infty (t_0,x_0), (t,x):(t,x)\in \text{Fr} (A) \}=\inf \{\max \{||t-t_0||,||x-x_0||\}\}\]
	...
	\[ R=\{(t,x):|t-t_0|<\varDelta, ||x-x_0||\leq H\delta\} \]
	$ R \subset A $ (Ejercicio). Idea para demostración: $ (t_1,x_1)\in R \Rightarrow (t_1,x_1)\in A $ y $ d_\infty ((t_1,x_1), (t_0,x_0))<d $.
	
	Si existe solución para (*) la tangente en $ (t_0,x_0) $ sería (ya que $ \varphi $ es solución):
	...
	Como $ f $ acotada en $ H $, tenemos $ ||f(t_0,x_0)||\leq H $.
	...
	\[ ||\rho_1'(t)-f(t,\rho_1(t))||=||f(t_0,x_0)-f(t,x_0+f(t_0,x_0))(t-t_0)|| \]
	\[ \begin{rcases}
	f \text{ continua en } A\\
	...
	Tengo que demostrar $ ||y-z||=||f(t_0,x_0)-f(t,x_0)+f(t_0,x_0)(t-t_0)||<\varepsilon $.
	
	Sea $ \varepsilon>0 $, como $ f $ uniformemente continua, si $ ||(t_0,x_0)-(t, x_0+f(t_0,x_0)(t-t_0))||< \hat{\delta} $ ya queda probado.
	Veamos para que valores de $ t $, se tiene $ ||(t_0,x_0)-(t, x_0+f(t_0,x_0)(t-t_0))||< \hat{\delta} \Rightarrow ||(t_0-t), x_0-x_0 -f(t_0,x_0)(t-t_0)||< \hat{\delta} $.
	
	NOTA: trabajo con la norma infinito, que es el máximo de los valores absolutos de las componentes.
	
	(1)
	\[ \begin{rcases}
	 \text{Si } ||t-t_0||< \hat{\delta}\\
	|| -f(t_0,x_0)(t-t_0)||< \hat{\delta}
	\end{rcases} \Rightarrow ||(t_0-t), f(t_0,x_0)(t-t_0)||< \hat{\delta} \]
	Sea $ \alpha >0 $ tal que $ \alpha < \min \{ \hat{\delta}, \frac{\hat{\delta}}{H}\} $ veamos que $ \forall t \in [t_0,t_0+\alpha] $, $\rho_1(t)$ es solución $ \varepsilon $-aproximada. 
	
	\[ t \in [t_0, t_0+\alpha]\Rightarrow |t-t_0|\leq \alpha  
	\begin{cases}
	< \hat{\delta} \text{ si } (min\{ \hat{\delta}, \frac{\hat{\delta}}{H}\}= \hat{\delta}) \\
	< \frac{\hat{\delta}}{H}\}<\hat{\delta} \text{ si }  (min\{ \hat{\delta}, \frac{\hat{\delta}}{H}\}=  \frac{\hat{\delta}}{H})
	\end{cases}
	 \]
	 \[  t \in [t_0, t_0+\alpha]\Rightarrow ||-f(t_0,x_0)(t-t_0)|| = || f(t_0,x_0)|| , |t-t_0|<H\alpha < H \frac{\hat{\delta}}{H}= \hat{\delta} \]
	...
	y veamos que $ \rho_2(t) $ es solución $ \varepsilon $-aproximada $  \forall t \in [t_1,t_1+\alpha]  $ y repetimos el proceso.
\end{proof}
\section{Tema 3.}
\pagebreak
\section{Tema 4.}
