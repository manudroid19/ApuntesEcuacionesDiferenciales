...
\newcommand{\iindex}[1]{\emph{\newcommand{\iindex}[1]{#1\index{#1}} }\index{#1}} 
...
\begin{definition}
	Diremos que $\mu : (t, x) \in I_1 \times I_2 \longrightarrow \mathbb{R}$ es un \emph{factor integrante} para $M(t, x)dt + N(t, x)dx = 0$ si:
