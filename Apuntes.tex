...
\begin{proof}[Solución]\ \\
	...
	\[h:t \in (- \infty, - c) \longrightarrow h(t) = \frac{-1}{t+c}\]
	\begin{enumerate}
		\item $(t, h(t)) \in A$
...
\begin{definition}
	...
	(t, x)& \longrightarrow f(t,x)
	\end{align*}
	Diremos que $f$ es lipschitziana en $A$ con respecto a la variable $x$ si $\exists k \in \mathbb{R}$, $k \geq 0$ tal que:
