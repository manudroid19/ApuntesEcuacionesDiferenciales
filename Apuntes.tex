...
BEGIN JORGE 18/03
Consideramos el sistema lineal en $\mathbb{R}^n$.
\[x'= A(t) + b(t)\]
Así que, $A$ y $b$ aplicaciones tal que:\\
\begin{align*}
	&A: t \in I \subset \mathbb{R} \longrightarrow A(t) \in M_{n \times n}(\mathbb{R}) \\ 
	&b: t \in I \subset \mathbb{R} \longrightarrow b(t) \in \mathbb{R} \text{ $I$ intervalo}
\end{align*}
pediremos que $A$ y $b$ continuas.
\[ \begin{pmatrix}
x_1' \\
\vdots \\
x_n'  
...
\end{cases}\]
\begin{definition}
	Si $b(t) = 0$ $\forall$ diremos que el sistema es homogéneo. Si $\exists t \in I$ diremos que el sistema es no hemogéneo o completo.
\end{definition}
\begin{theorem}
	Sea $I$ intervalo abierto $I = (a, b)$ y $A$, $b$ funciones continuas en $I$. Entonces, fijado $(t_0, x_0) \in I \times \mathbb{R}^n$ existe solución para $x'= A(t)x + b(t)$ pasando por $(t_0, x_0)$, es única y la solución maximal definida en I.
\end{theorem}
\begin{proof}\ \\
	Tomando
	\[f:(t, x) \in I \times \mathbb{R}^n \longrightarrow \mathbb{R}^n\]
	...
	por lo que, por Picar-Lipschitz, $\forall (t_0, x_0) \in D$ existe solución única pasando por $(t_0, x_0)$. \\
	Veamos que la solución maximal está definida en $I$. Para ello veremos si podemos aplicar el teorema de la banda. Para ello veremos si:
	\begin{enumerate}
		\item $f$ continua en $D$.
		\item $f \in L_k (D, x)$.
	\end{enumerate}
	Ya tenemos que $f$ es continua por hipótesis. Vemos que $f$ es localmente Lipschitziana en $D$ respecto a la variable $x$ empezando porque:
