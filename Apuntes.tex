...
\begin{enumerate}[\quad i)]
	...
	A partir de este resultado, construimos un método práctico de resolución. Por ser $ x(t) $ solución, ha de verificar$ x'(t)=a(t)x+b(t) $, s decir,
	...
	Es decir, será la suma de la solución de la homogénea con la solución particular de la completa para $ k=0 $.
\end{enumerate}
