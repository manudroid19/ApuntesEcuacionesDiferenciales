...
\end{proof}
\begin{theorem}
	Si $f \in C^r$, $r \in \mathbb{N}$ y $r \leq 1$, entonces $\varphi \in C^{r+1}(I)$.
\end{theorem}
\begin{proof}
	...
	Supongamois ahora cierto para un $r$ arbitrario y probémoslo para $r+1$. Sea $f \in C^{r+1} (A)$ (por lo que $f \in C^r \stackrel{HIP}{\Rightarrow}$ $\varphi \in C^{r+1}$). Veamos que $\varphi \in C^{r+1}$.
...
\begin{exercise}
	Se proponen los siguientes ejercicios teóricos:
	\begin{enumerate}
		\item Razona veracidad o falsedad:
		...
		\end{enumerate}
	\item $ x'=f(t,x) $
	\[ f:(t,x)\in (-\pi, 33)\times \mathbb{R} \] DEL SEMINARIO
	\end{enumerate}
\end{exercise}
\begin{proof}[Solución]
	\begin{enumerate}
		...
		\begin{enumerate}[\quad a)]
			...
			\end{enumerate} 
		\item Probemos que es falso por reducción al absurdo. Supongamos que está definida en un intervalo de la forma $ ( $
		\end{enumerate}
	\end{enumerate}
\end{proof}
...
\begin{proof}
	...
	\begin{enumerate}[\quad i)]
		...
		$ \det (\psi(t))=\det(\phi(t))\det(\varOmega)\neq 0 $, por ser $ \phi $ fundamental y $ \varOmega $ no singular. Es decir, $ \psi(t) $ fundamental.0
	\end{enumerate}
\end{proof}
\pagebreak
\section{Tema 4.}
